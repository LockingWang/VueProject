<template>
    ...
    <header>
      ...
      >
        <swiper-slide>
          <img class="w-100"
          src="@/assets/images/user-products-banner/main-banner.svg" alt="Products Page Banner">
          <router-link to="/products" class="stretched-link"></router-link>
        </swiper-slide>
        <swiper-slide>
          <img class="w-100"
            src="@/assets/images/user-products-banner/tokyo-promo.svg" alt="Promotion Banner">
          <router-link to="/product/-NTlt20QPr7IxM7ZdsrD" class="stretched-link"></router-link>
        </swiper-slide>
        <swiper-slide>
          <img class="w-100"
            src="@/assets/images/user-products-banner/ninja-coupon.svg" alt="Coupon Banner">
